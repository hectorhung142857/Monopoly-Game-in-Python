...
dice = [pygame.transform.scale(pygame.image.load('骰子/1.png'), (75, 75)),
        pygame.transform.scale(pygame.image.load('骰子/2.png'), (75, 75)),
        pygame.transform.scale(pygame.image.load('骰子/3.png'), (75, 75)),
        pygame.transform.scale(pygame.image.load('骰子/4.png'), (75, 75)),
        pygame.transform.scale(pygame.image.load('骰子/5.png'), (75, 75)),
        pygame.transform.scale(pygame.image.load('骰子/6.png'), (75, 75))]
